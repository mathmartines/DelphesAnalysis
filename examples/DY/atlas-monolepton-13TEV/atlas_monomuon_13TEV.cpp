...
int main() {
    ...
    const AnalysisCuts monoe_cuts ({&leadMuonCut, &leptonsVeto, &metcuts, &metcuts, &mtcut});
    ...
    /// root to the folder
    TString simulation_folder = "/home/martines/work/MG5_aMC_v3_1_1/PhD/DY/atlas-monomu-13TEV/recast/";
    /// all the masses
    ...
    for (auto simulation: folders) { 
        ...
        event_loop.addFile(simulation_folder + simulation + "/delphes_default3.root");
